        ...
        <div className="flex gap-4">
          ...
          >
            <input
              type="checkbox"
              checked={
                rooms.length > 0 && selectedDelete.length === rooms.length
              }
              onChange={(e) => {
                if (e.target.checked) {
                ...
                >
                  {isSelected ? (
                    <div className="flex justify-center items-center">
                      <input
                        type="checkbox"
                        checked={selectedDelete.includes(room.id)}
                        onChange={() => handleCheck(room.id)}
                        className="w-[33px] h-[33px] bg-white border-2 rounded checked:bg-[#0e327a] cursor-pointer"
                      />
                    </div>
                  ) : (
                    <div className="flex justify-center gap-2">
                      <button
                        ...
                        className="gap-3 items-center flex px-2 py-1 md:py-1.5 md:px-3 text-sm md:text-base bg-red-500 text-white hover:bg-red-600 rounded cursor-pointer transition-all duration-300"
                      >
                        <Trash className="" />
                        <span>ลบ</span>
                      </button>
